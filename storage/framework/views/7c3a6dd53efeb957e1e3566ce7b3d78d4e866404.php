            ...
            <table  class="first-table" style="text-align:center; border-spacing: 5px; border-collapse: separate; font-size: 12px;">
                ...
                <?php if(in_array('1',request('table')) ): ?>
                    ...
                    <tr>
                        ...
                        <td class="td_number" style="background-color:#eeebf6;border: 1px solid #9a96a5; font-weight: bold;width: 12%"> <?php echo e(number_format($item->total_price(), 1)); ?></td>

                        <td style="background-color:#d5d2dd; font-weight: bold;width: 10%; border: 1px solid #9a8d98">قيمة المباع</td>
                        <td class="td_number" style="background-color:#eeebf6; border: 1px solid #9a96a5; font-weight: bold;width: 12%"> <?php echo e(number_format($item->total_price_solds(), 1)); ?></td>
                ...
                <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <td class="td_number" style="background-color:#eadcd9; border: 1px solid #887c7b; font-weight: bold;width: 8%"> <?php echo e($allProductsRemaininPrice); ?></td>
