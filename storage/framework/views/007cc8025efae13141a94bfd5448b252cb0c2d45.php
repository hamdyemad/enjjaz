            ...
            <?php if(in_array('3',request('table')) ): ?>
                ...
                <table border="1" style="text-align:center; border-color:black;font-size: 13px;" >
                    ...
                    <tr style="background-color:lightgray;font-weight:bold">
                        ...
                        <td style="width:35%; background-color: #dde1bc;">الكتاب</td>
                        <td style="background-color:#e9dced;width:13%">الكمية</td>
                        <td style="background-color:#e9dced;width:13%">المتبقى</td>
                        <td style="background-color:#e4d2c6;width:12%">السعر</td>
                        <td style="background-color:#d2e7d4;width:20%">السعر الكلي</td>
                    </tr>
...
<?php /**PATH /home/enjjaz/public_html/resources/views/admin/order/pdf/index.blade.php ENDPATH**/ ?>