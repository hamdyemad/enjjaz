                        ...
                        <div class="col-lg-12">
                            <form action="<?php echo e(route('expense.store')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('notes', null, array('placeholder' => 'الملاحظات','class' => 'form-control')); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enjjaz/public_html/resources/views/admin/expense/create.blade.php ENDPATH**/ ?>