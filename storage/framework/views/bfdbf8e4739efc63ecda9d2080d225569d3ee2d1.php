                            ...
                            <form action="<?php echo e(route('publication.store')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <?php if(request('type') == 1): ?>
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::text('product_id', null, array('placeholder' => 'أسم المطبوع','class' => 'form-control')); ?>
                                ...
                                <div class="form-group">
                                    <label>الكمية</label>
                                    <?php echo Form::number('count', null, array('placeholder' => 'الكمية','class' => 'form-control count')); ?>
                                ...
                                <div class="form-group">
                                     <input type="text" hidden name="type" value="<?php echo e(request('type')); ?>">
                                </div>


                                <div class="form-group">
                                    <label>السعر الاجمالي</label>
                                    <?php echo Form::text('total_price', null, array('placeholder' => 'السعر الاجمالي','class' => 'form-control total_price')); ?>

                                </div>
                                <div class="form-group">
                                    <label> سعر الطبعة الواحدة</label>
                                    <?php echo Form::text('price', null, array('placeholder' => ' السعر','class' => 'form-control price')); ?>

                                </div>
                                <div class="form-group">
                                    <label>رقم الطبعة</label>
                                    <?php echo Form::number('copy_no', null, array('placeholder' => 'رقم الطبعة','class' => 'form-control')); ?>

                                </div>
                                <div class="form-group">
                                    <label>تاريخ الطبعة</label>
                                    <?php echo Form::date('date', date("Y/m/d"), array('placeholder' => 'تاريخ الطبعة','class' => 'form-control')); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enjjaz/public_html/resources/views/admin/publication/create.blade.php ENDPATH**/ ?>