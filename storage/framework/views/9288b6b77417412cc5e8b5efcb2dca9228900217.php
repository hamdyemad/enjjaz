...
<body>
    <table  border="1" style="text-align:center; border-color:black;">
        ...
        <?php $__currentLoopData = $publicationExpenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
...
<?php /**PATH C:\xampp\htdocs\app\resources\views/admin/publication/pdf/pdf-all.blade.php ENDPATH**/ ?>