<table id="headerStyle" width="100%" style=" font-size: 14px;">
    <tr style="margin: 2em">
        <td style="border-bottom: 2px solid #3c763d;color: #3c763d; width:40%">قسم: الزبائن</td>
...
<?php /**PATH /home/enjjaz/public_html/resources/views/admin/customer/pdf/header.blade.php ENDPATH**/ ?>