                            ...
                            <div class="form-group" style="width: 200px;">
                                <form action="<?php echo e(route('order.create')); ?>" method="GET">
                                    <select class="form-control select2" name="price" onchange="this.form.submit()">
                                        <option value="0"<?php if(request('price') == 0): ?> selected <?php endif; ?>>السعر العادى</option>
                                        <option value="1"<?php if(request('price') == 1): ?> selected <?php endif; ?>>سعر الجملة</option>
                                    </select>
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <form action="<?php echo e(route('order.store') . '?price=' . request('price')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enjjaz/public_html/resources/views/admin/order/create.blade.php ENDPATH**/ ?>