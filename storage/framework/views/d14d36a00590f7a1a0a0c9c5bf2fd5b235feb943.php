                        ...
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <?php $__currentLoopData = $item->payments()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a data-toggle="modal" data-target="#update_date-<?php echo e($payment->id); ?>"><?php echo e($payment->created_at->format('d-m-y h:i A')); ?></a>
                                    </td>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enjjaz/public_html/resources/views/admin/order/edit.blade.php ENDPATH**/ ?>