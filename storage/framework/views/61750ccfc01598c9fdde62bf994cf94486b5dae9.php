                        ...
                        <div class="col-lg-12">
                            <form action="<?php echo e(route('roles.update', $role->id)); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>الاسم</label>
                                    <?php echo Form::text('name', $role->name, array('placeholder' => 'الاسم','class' => 'form-control')); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enjjaz/public_html/resources/views/admin/roles/edit.blade.php ENDPATH**/ ?>