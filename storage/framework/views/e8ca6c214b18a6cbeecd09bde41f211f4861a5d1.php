                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('publication-list')): ?>
                            <li>
                                <a href="<?php echo e(route('publication.home')); ?>"><i class="fa fa-book fa-fw"></i>  المطبوعات </a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('alert-list')): ?>
                            <li>
                                <a href="<?php echo e(route('alert.index')); ?>">
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('receipt-list')): ?>
                            <li>
                                <a href="<?php echo e(route('receipt.home')); ?>"><i class="fas fa-receipt"></i> الايصالات </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('track-list')): ?>
                        <li>
                            <a  href="<?php echo e(route('track.home')); ?>"><i class="fas fa-truck-loading"></i> شركات التوصيل </a>
                        </li>
                        <?php endif; ?>
...
<?php /**PATH /home/enjjaz/public_html/resources/views/admin/layout/master.blade.php ENDPATH**/ ?>