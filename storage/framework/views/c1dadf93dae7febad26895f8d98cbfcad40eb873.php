                        ...
                        <div class="col-lg-12">
                            <form action="<?php echo e(route('expense.update',$item->id)); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('notes', $item->notes, array('placeholder' => 'الملاحظات','class' => 'form-control')); ?>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/enjjaz/public_html/resources/views/admin/expense/edit.blade.php ENDPATH**/ ?>