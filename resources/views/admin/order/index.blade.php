...
@section('content')
    @include('admin.include.head',['title'=>'الطلبات '])
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="pull-left">
                        @can('order-create')
                            <a class="btn btn-success btn-xs" href="{{ route('order.create') . '?price=' . 0 }}"> <i class="fa fa-plus"></i>اضافة</a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="row">
                        <form action="{{route('order.index')}}" method="get" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="col-lg-3">
                                <div class="form-group">
                                    {!! Form::select('customer_id',$users->pluck('name', 'id'),request('customer_id'), array('placeholder' => 'اسم المكتبة','class' => 'form-control select2')) !!}
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <select class="form-control select2" name="status" id="status">
                                        ...
                                        @foreach(['1'=>'سارية','4'=>'مدفوعة','3'=>'ملغية'] as $k=>$v)
                                            <option value="{{$k}}" {{ request('status')!= '' ? request('status') == $k ? 'selected' : '': '' }}>
                                                {{$v}}
                                            </option>
                                        @endforeach
                                    </select>
