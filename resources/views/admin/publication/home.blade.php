...
<div class="row">
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-yellow">
            ...
            @can('order-list')
                <a href="{{route('publication.index',['type'=>'0'])}}" class="coin-link" pull-link="#">
    ...
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-green">
            ...
            @can('order-list')
            <a href="{{route('publication.index',['type'=>'1'])}}" class="coin-link" pull-link="#">
                <div class="panel-footer">
                        <span class="pull-left">عرض التفاصيل</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="panel" style="background-color:rgb(16, 115, 207); color:white">
            ...
            @can('order-list')
            <a href="{{route('publication.index',['type'=>'2'])}}" class="coin-link" pull-link="#">
                <div class="panel-footer">
                        <span class="pull-left">عرض التفاصيل</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
...
<div class="row">
    <div class="col-lg-4 col-md-6">
        <div class="panel panel-danger">
            ...
            @can('order-list')
                <a href="{{route('publication.pdfAllExpense')}}" class="coin-link" pull-link="#">
                    <div class="panel-footer">
